...
<body>
<!-- nav bar -->
<nav class="fixed top-0 left-0 py-2 px-2 xl:px-36 min-h-[4vh] w-full bg-darkGray1 text-sm z-50">
...
<nav class="relative py-2 px-2 md:px-5 xl:px-36 w-full h-12 bg-lightGray1 sticky top-[66px] md:top-[72px] z-10">
        ...
        <div class="flex flex-row text-white text-bold">
            <div class="flex flex-col">
                <button class="peer px-3 bg-lightGray1 text-white h-full"><a class="hidden md:flex mr-4 hover:text-red ease-in duration-200"
                                                                             href="gender/sieviesu/sieviesu.php">SIEVIETĒM</a></button>
                <div
                    ...
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200 pt-2"
                       href="gender/sieviesu/s_apavi.php">APAVI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/sieviesu/s_dzemperi.php">DŽEMPERI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/sieviesu/s_bikses.php">BIKSES</a>
                    <a class="hover:text-red text-black text-bold ease-in duration-200 pb-2"
                       href="gender/sieviesu/s_jakas.php">JAKAS</a>
                </div>
            </div>
            <div class="flex flex-col">
                <button class="peer px-3 bg-lightGray1 text-white h-full"><a class="hidden md:flex mr-4 hover:text-red ease-in duration-200"
                                                                             href="gender/viriesu/viriesu.php">VĪRIEŠIEM</a></button>
                <div
                        class="absolute hidden w-24 peer-hover:flex hover:flex flex-col bg-white drop-shadow-lg text-center mt-6">
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200 pt-2"
                       href="gender/viriesu/v_apavi.php">APAVI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/viriesu/v_dzemperi.php">DŽEMPERI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/viriesu/v_bikses.php">BIKSES</a>
                    <a class="hover:text-red text-black text-bold ease-in duration-200 pb-2"
                       href="gender/viriesu/v_jakas.php">JAKAS</a>
                </div>
            </div>
            <div class="flex flex-col">
                <button class="peer px-3 bg-lightGray1 text-white h-full"><a class="hidden md:flex mr-4 hover:text-red ease-in duration-200"
                                                                             href="gender/bernu/bernu.php">BĒRNIEM</a></button>
                <div
                        class="absolute hidden w-24 peer-hover:flex hover:flex flex-col bg-white drop-shadow-lg text-center mt-6">
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200 pt-2"
                       href="gender/bernu/b_apavi.php">APAVI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/bernu/b_dzemperi.php">DŽEMPERI</a>
                    <a class="hover:text-red text-black text-bold mb-2 ease-in duration-200"
                       href="gender/bernu/b_bikses.php">BIKSES</a>
                    <a class="hover:text-red text-black text-bold ease-in duration-200 pb-2"
                       href="gender/bernu/b_jakas.php">JAKAS</a>
                </div>
            </div>
        </div>
        <!-- hamburger -->
    ...
    <div class="md:hidden">
        <div id="menu"
            ...
            <a href="gender/sieviesu/sieviesu.php" class="text-red">SIEVIETĒM</a>
            <div class="flex flex-col items-center gap-y-2">
                <a href="gender/sieviesu/s_apavi.php" class="hover:text-darkGray1ishBlue">APAVI</a>
                <a href="gender/sieviesu/s_dzemperi.php" class="hover:text-darkGray1ishBlue">DZEMPERI</a>
                <a href="gender/sieviesu/s_bikses.php" class="hover:text-darkGray1ishBlue">BIKSES</a>
                <a href="gender/sieviesu/s_jakas.php" class="hover:text-darkGray1ishBlue">JAKAS</a>
            </div>
            <a href="gender/viriesu/viriesu.php" class="text-red">VĪRIEŠIEM</a>
            <div class="flex flex-col items-center gap-y-2">
                <a href="gender/viriesu/v_apavi.php" class="hover:text-darkGray1ishBlue">APAVI</a>
                <a href="gender/viriesu/v_dzemperi.php" class="hover:text-darkGray1ishBlue">DZEMPERI</a>
                <a href="gender/viriesu/v_bikses.php" class="hover:text-darkGray1ishBlue">BIKSES</a>
                <a href="gender/viriesu/v_jakas.php" class="hover:text-darkGray1ishBlue">JAKAS</a>
            </div>
            <a href="gender/bernu/bernu.php" class="text-red">BĒRNIEM</a>
            <div class="flex flex-col items-center gap-y-2">
                <a href="gender/bernu/b_apavi.php" class="hover:text-darkGray1ishBlue">APAVI</a>
                <a href="gender/bernu/b_dzemperi.php" class="hover:text-darkGray1ishBlue">DZEMPERI</a>
                <a href="gender/bernu/b_bikses.php" class="hover:text-darkGray1ishBlue">BIKSES</a>
                <a href="gender/bernu/b_jakas.php" class="hover:text-darkGray1ishBlue">JAKAS</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="flex flex-col justify-center items-center gap-2 lg:gap-10 xl:gap-24 md:flex-row">
    <div class="relative md:ml-2">
        <a href="gender/sieviesu/sieviesu.php" class="hover:box-shadow"><img src="img/women.png"
                                                                         class="w-96 rounded-md hover:box-shadow"></a>
        <p class="absolute bottom-8 pl-4 text-2xl font-bold text-black">SIEVIETĒM</p>
    </div>
    <div class="relative">
        <a href="gender/viriesu/viriesu.php" class="hover:box-shadow"><img src="img/men.png"
                                                                       class="w-96 rounded-md hover:box-shadow"></a>
        <p class="absolute bottom-8 pl-4 text-2xl font-bold text-black">VĪRIEŠIEM</p>
    </div>
    <div class="relative md:mr-2">
        <a href="gender/bernu/bernu.php"><img src="img/bernu.png" class="w-96 rounded-md hover:box-shadow"></a>
