...
$sql = "SELECT * FROM products_sieviesu WHERE kategorija = ?";
...
<div class="container mx-auto py-8">
    ...
    <div class="text-center mb-10 mt-10 text-bold">
        <h1 class="text-3xl font-bold">SIEVIEŠU BIKSES</h1>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 place-items-center">
      ...
      <div class="h-[360px] sm:h-[400px] lg:h-[480px] w-[159px] sm:w-[186px] lg:w-60 border-2 border-zinc-900 rounded-[12px] m-4 sm:m-8 hover:box-shadow hover:cursor-pointer">
